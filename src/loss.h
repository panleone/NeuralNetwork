 ...
 * Since the backward step can be simplified a lot (algebraically), it is better to write a custom
 * class for it, instead of using the computational graph directly.
 */
